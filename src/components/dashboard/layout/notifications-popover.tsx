...
const notifications: Array<{
	...
	createdAt: Date;
	read: boolean;
	type: 'new_job' | 'new_feature' | 'new_company';
...
export function NotificationsPopover({ anchorEl, onClose, onMarkAllAsRead, onRemoveOne, open = false }: NotificationsPopoverProps) {
	return (
		<Popover
			anchorEl={anchorEl}
...
function NotificationItem({ divider, notification, onRemove }: NotificationItemProps) {
	return (
...
function NotificationContent({ notification }: { notification: NotificationItemProps['notification'] }) {
