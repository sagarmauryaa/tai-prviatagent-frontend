...
export function MobileNav({ items = [], open, onClose }: MobileNav) {
			...
			<Stack spacing={2} sx={{ p: 2 }}>
				<div>
					<Box component={RouterLink} href={paths.home} sx={{ display: "inline-flex" }}>
						<Logo color="light" emblem={true} height={32} width={122} />
					</Box>
				</div>
			</Stack>
...
function renderNavGroups({ items, onClose, pathname }: { items: NavItemsType; onClose: () => void; pathname: string }) {
